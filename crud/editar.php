...
?>
        ...
        <form action="editarProcesamiento.php" method="post" enctype="multipart/form-data">
        <div class="form-group">
            ...
            <div class="form-group">
                ...
                <textarea class="cajas-texto" rows="10" style=" width: 100%; height: auto; resize: none; overflow: hidden; color: #040505; background-color: oldlace" name="descripcion" placeholder="descripcion" > <?php echo $row["descripcion"];?></textarea>
            </div>
            <br>
