...
if($imagenCatalogo=="../images/" && $imagenDescripcion=="../imagenesDescripcion/"){

    $consultaUpdate = "UPDATE  articulos SET 
    nombreProducto='$nombreProducto',precio=$precio,descripcion=' $descripcion',categoria_id=$categoria,nombreMarca_id=$nombreMarca,nuevo=$nuevo
     WHERE id=$id";
...
//echo $consultaUpdate;
    ...
    $consultaUpdate = "UPDATE  articulos SET 
    nombreProducto='$nombreProducto',precio=$precio,imagenCatalogo='$imagenCatalogo',imagenDescripcion='$imagenDescripcion',descripcion=' $descripcion',categoria_id=$categoria,nombreMarca_id=$nombreMarca,nuevo=$nuevo
     WHERE id=$id";
...
if (mysqli_query($conexion, $consultaUpdate)) {
    echo "Se actualizaron los datos del Producto ".$nombreProducto;
} else {
